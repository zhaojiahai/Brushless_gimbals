...
{
	static u8 cnt = 0;
	static u8 senser_cnt 	= 10;				//传感器频率100HZ
	static u8 status_cnt 	= 15;				//状态频率1000/15HZ
	static u8 rcdata_cnt 	= 20;				//遥控数据频率50HZ
	static u8 motopwm_cnt	= 20;				//PWM频率50HZ
	static u8 power_cnt		= 50;				//电压频率20HZ
	static u8 version_cnt	= 200;				//更新下位机版本
	static u8 location_cnt  = 200;				//发送GPS信息
	...
	if((cnt % version_cnt) == (version_cnt-1))
		f.send_version =1;
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_version = 0;
		ANO_DT_Send_Version(4,300,100,400,0);		//领航者飞控
	}
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(mpu6050.Acc_I16.x,mpu6050.Acc_I16.y,mpu6050.Acc_I16.z,
												mpu6050.Gyro_I16.x,mpu6050.Gyro_I16.y,mpu6050.Gyro_I16.z,
												0,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////	
	...
	{
		f.send_motopwm = 0;
		ANO_DT_Send_MotoPWM(10,20,30,400,500,600,700,800);		//@HackOS: 电机PWM值
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_power)
	{
		f.send_power = 0;
		ANO_DT_Send_Power(123,456);								//@HackOS: 电压电流
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid1)
	{
...
//											ctrl_2.PID[PIDYAW].kp,ctrl_2.PID[PIDYAW].ki,ctrl_2.PID[PIDYAW].kd);
	...
	else if(f.send_location == 2)
	{
		...
		f.send_location = 0;
		ANO_DT_Send_Location(3,20,120.35 *10000000,36.2  *10000000,45);
